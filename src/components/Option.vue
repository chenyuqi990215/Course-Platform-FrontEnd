...
<div class="Option-container">
  ...
  <ul>
    <li v-for="(data,index) in options_classes" :key='index'>
      <p v-bind:class="{classes:!options_states[index].option,showClasses:options_states[index].option}" v-on:click="showOption(index)">
        {{data.option}}
      </p>
    </li>
  </ul>
  ...
  <ul>
    <li v-for="(data,index) in options_lan" :key='index'>
      <p v-bind:class="{classes:!lan_states[index].option,showClasses:lan_states[index].option}" v-on:click="showLan(index)">
        {{data.option}}
      </p>
    </li>
  </ul>
